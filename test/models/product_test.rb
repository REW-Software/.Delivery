...
class ProductTest < ActiveSupport::TestCase
  test "Criar Product" do
    ...
    product = Product.new(name: 'ProdutoLegal', price: 10.00, discount: 1.00, product_quantity: 2, sale_id: sale.id)
    assert product.save
  end
  ...
  test "Criar produto com price invalido" do
    ...
    product = Product.new(name: 'ProdutoLegal', price: 'abc', discount: 1.00, product_quantity: 2, sale_id: sale.id)
